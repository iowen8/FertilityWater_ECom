...
namespace Nop.Plugin.Widgets.BannerSlider.Models
{
    public class ConfigurationModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Plugins.Widgets.BannerSlider.Picture")]
        [UIHint("Picture")]
        public int Picture1Id { get; set; }
        public bool Picture1Id_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.BannerSlider.Text")]
        [AllowHtml]
        public string Text1 { get; set; }
        public bool Text1_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.BannerSlider.Link")]
        [AllowHtml]
